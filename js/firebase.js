...
async function register(username, password) {
  try {
    ...
    const userCredential = await createUserWithEmailAndPassword(auth, username + "@gmail.com", "ifuckinghategoogle"+ String(password) + "likefrbrowtf666");
...
async function login(username, password) {
  try {
    const userCredential = await signInWithEmailAndPassword(auth, username + "@gmail.com", "ifuckinghategoogle"+ String(password) + "likefrbrowtf666");
    const user = userCredential.user;
